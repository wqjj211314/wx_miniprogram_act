...
Page({
  ...
  onLoad(options) {
    ...
    this.setData({
      ...
      good_title: good_info.good_title,
      good_type: good_info.good_type,
      good_size: good_info.good_size,
      good_color: good_info.good_color,
      good_tag: good_info.good_tag,
      good_price: good_info.good_price*100,
      good_deliver_options: good_info.good_deliver_options,
      imgList: good_info.good_img,
  ...
  update_good() {
    ...
    wx.request({
      url: app.globalData.hosturl + 'update_good', //仅为示例，并非真实的接口地址
      data: {
