...
Page({
  ...
  onLoad(options) {
    ...
    this.setData({
      ...
      club_place_environment: placeinfo.club_place_environment,
      club_place_limit: placeinfo.club_place_limit,
      club_place_price: placeinfo.club_place_price,
      club_place_miniprogram_link: placeinfo.club_place_miniprogram_link,
      club_place_other_info: placeinfo.club_place_other_info,
      club_place_detail: placeinfo.club_place_detail,
      club_place_address: placeinfo.club_place_address,
