...
function check_login(app){
  ...
  if(app.globalData.login_userInfo["user_id"] == ""||app.globalData.login_userInfo["user_id"] == undefined||app.globalData.login_userInfo["nickName"] == ""||app.globalData.login_userInfo["gender"] == -1||app.globalData.login_userInfo["avatarUrl"] == ""){
    console.log("跳转到登录界面")
    wx.navigateTo({
